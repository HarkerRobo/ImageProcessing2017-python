...
def process(left_img, right_img):
    ...
    R1, R2, P1, P2, Q, roi1, roi2 = cv2.stereoRectify(cameraMatrix1=calib_dict["left"]["camera_matrix"], distCoeffs1=calib_dict["left"]["dist_coeffs"],
                                                      cameraMatrix2=calib_dict["right"]["camera_matrix"], distCoeffs2=calib_dict["right"]["dist_coeffs"],
